class Obra:
    ...
    Atributos:
        ...
        imagen_obra (str)        
    """
    def __init__(self, titulo, artista, nacionalidad_artista, fecha_nacimeinto_art, fecha_muerte_art, tipo, anio_creacion):
        self.titulo = titulo
...
Fecha de nacimiento del artista: {self.fecha_na_art}
